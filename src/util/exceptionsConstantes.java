...
public class exceptionsConstantes {
        ...
        public static final String ERREUR_UPDATE_DISPONIBILITE = "Erreur lors de la mise à jour de la disponibilité.";

        public static final String ERREUR_SAUVEGARDE_PATIENT = "Erreur lors de l'enregistrement du patient.";
        public static final String PATIENT_NON_TROUVE = "Aucun patient trouvé avec cet email.";

        public static final String UTILISATEUR_NON_TROUVE = "Aucun utilisateur trouvé avec cet email et mot de passe.";
        public static final String UTILISATEUR_NON_VALIDE = "L'utilisateur doit être un patient pour réserver un rendez-vous.";

        public static final String ERREUR_SAUVEGARDE_RDV = "Erreur lors de la sauvegarde du rendez-vous.";
